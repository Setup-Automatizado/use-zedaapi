...
export default function UpcomingRenewalEmail({
	userName = "Usuário",
	...
	const formattedDate = renewalDate
		? new Date(renewalDate).toLocaleDateString("pt-BR")
		: "—";
	...
	return (
		<Html>
			<Head />
			<Preview>
				Renovação em 3 dias — {amount} — Zé da API Manager
			</Preview>
			<Body style={main}>
				<Container style={container}>
					<Heading style={logo}>Zé da API Manager</Heading>
					<Hr style={hr} />
					<Heading style={heading}>Renovação em Breve</Heading>
					<Text style={paragraph}>Olá {userName},</Text>
					<Text style={paragraph}>
						Sua assinatura será renovada automaticamente em 3 dias.
						Verifique se seu método de pagamento está atualizado.
					</Text>
