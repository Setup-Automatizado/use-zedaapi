...
interface SubscriptionResumedEmailProps {
	userName?: string;
	planName?: string;
	amount?: string;
...
export default function SubscriptionResumedEmail({
	...
	return (
		<Html>
			<Head />
			<Preview>Assinatura reativada — Zé da API Manager</Preview>
			<Body style={main}>
				<Container style={container}>
					<Heading style={logo}>Zé da API Manager</Heading>
					<Hr style={hr} />
					<Heading style={heading}>Assinatura Reativada!</Heading>
					<Text style={paragraph}>Olá {userName},</Text>
					<Text style={paragraph}>
						Sua assinatura foi reativada com sucesso. Todos os seus
						recursos e instâncias estão funcionando normalmente.
					</Text>
					...
					<Section style={detailsBox}>
						...
						<Text style={detailRow}>
							<strong>Próxima cobrança:</strong> {formattedDate}
						</Text>
					</Section>
