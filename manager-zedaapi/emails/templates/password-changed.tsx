...
export default function PasswordChangedEmail({
	...
	return (
		<Html>
			<Head />
			<Preview>Sua senha foi alterada — Zé da API Manager</Preview>
			<Body style={main}>
				<Container style={container}>
					...
					<Section style={warningBox}>
						...
						<Text style={warningBody}>
							Se você não realizou essa alteração, sua conta pode
							estar comprometida. Entre em contato com nosso
							suporte imediatamente para proteger sua conta.
						</Text>
					</Section>
