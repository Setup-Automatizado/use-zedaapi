...
export default function ReferralConvertedEmail({
	...
	return (
		<Html>
			<Head />
			<Preview>Indicação convertida — Zé da API Manager</Preview>
			<Body style={main}>
				<Container style={container}>
					<Heading style={logo}>Zé da API Manager</Heading>
					<Hr style={hr} />
					<Heading style={heading}>Indicação Convertida!</Heading>
					<Text style={paragraph}>Olá {userName},</Text>
					<Text style={paragraph}>
						Uma das suas indicações se tornou cliente pagante.
						Parabéns!
					</Text>

					<Section style={detailsBox}>
						<Text style={detailRow}>
							<strong>Cliente:</strong> {referralName}
						</Text>
						<Text style={detailRow}>
							<strong>Plano escolhido:</strong> {planName}
						</Text>
						<Text style={detailRow}>
							<strong>Sua comissão:</strong> {commissionAmount}
						</Text>
					</Section>
