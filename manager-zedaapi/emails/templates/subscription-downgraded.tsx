...
export default function SubscriptionDowngradedEmail({
	userName = "Usuário",
	oldPlan = "Profissional",
	newPlan = "Starter",
	newPrice = "R$ 97,00/mês",
	effectiveDate,
	...
	return (
		<Html>
			<Head />
			<Preview>Downgrade de plano — Zé da API Manager</Preview>
			<Body style={main}>
				<Container style={container}>
					<Heading style={logo}>Zé da API Manager</Heading>
					<Hr style={hr} />
					<Heading style={heading}>Downgrade de Plano</Heading>
					<Text style={paragraph}>Olá {userName},</Text>
					<Text style={paragraph}>
						Confirmamos a alteração do seu plano. O downgrade será
						aplicado ao final do período de cobrança atual. Até lá,
						você continua com acesso aos recursos do plano {oldPlan}
						.
					</Text>
					...
					<Text style={noteText}>
						Alguns recursos podem não estar disponíveis no novo
						plano. Verifique os limites do plano {newPlan} no
						painel.
					</Text>
