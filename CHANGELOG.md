...
## [2.0.0-develop.1](https://github.com/Funnelchat20/whatsapp-api-golang/compare/v1.2.0-develop.3...v2.0.0-develop.1) (2026-01-23)

### ⚠ BREAKING CHANGES

* **events:** Events with waitingMessage=true and receipts from
secondary devices are now filtered by default. Set the corresponding
environment variables to false to restore previous behavior.
...
* **health:** add build metadata to health endpoint ([c4dea32](https://github.com/Funnelchat20/whatsapp-api-golang/commit/c4dea322c292341746a6664df0b804790025328c))
...
* **scripts:** add deploy-all script for local deployment ([ea0a6d1](https://github.com/Funnelchat20/whatsapp-api-golang/commit/ea0a6d1c436648075186d5ae31e1df4d2c643ea4))
...
* **events:** add filters for waitingMessage and secondary device receipts ([335a7ac](https://github.com/Funnelchat20/whatsapp-api-golang/commit/335a7ac3c4aa065d6d5dfffce7ee2091b9c19a9e))
* **instances:** add GetByID public method ([b5fbd5d](https://github.com/Funnelchat20/whatsapp-api-golang/commit/b5fbd5dc06d1fc316fb82b7d92020fd8e855c14a))
...
* **registry:** add IsConnected method for connection status ([c1e0a96](https://github.com/Funnelchat20/whatsapp-api-golang/commit/c1e0a9691ab1627fc4aadc2956b4bfb23ebf74f2))
...
* **qr:** add QR code event handler for cache updates ([c4bae17](https://github.com/Funnelchat20/whatsapp-api-golang/commit/c4bae17903d4baf92417d597c5ebed45ec5da133))
...
* **encoding:** add support for PushName, BusinessName, UserAbout events ([914ab20](https://github.com/Funnelchat20/whatsapp-api-golang/commit/914ab206ce0957fe7043b90bf845d4aa411a0e44))
...
* **tools:** add webhook interceptor for development testing ([334b2c8](https://github.com/Funnelchat20/whatsapp-api-golang/commit/334b2c82ed36cd521ca9b6ce27a25f6c9d707ac7))
...
* **groups:** add Z-API compatibility fields to groups list endpoint ([7f150d5](https://github.com/Funnelchat20/whatsapp-api-golang/commit/7f150d533f936bedaf90d82a5299eb78b8a30258))
...
* **api:** add no-cache headers to instance endpoint ([e271e1c](https://github.com/Funnelchat20/whatsapp-api-golang/commit/e271e1c3f32591425eb5d9fcf520e68bdb6e2b6e))
...
* **presence:** distinguish RECORDING status from COMPOSING using media type ([a0dd6d5](https://github.com/Funnelchat20/whatsapp-api-golang/commit/a0dd6d5ed5aff8439addbd19110bb7a6ce023b1f))
* **messages:** enable message service and fix compilation errors ([068b8f8](https://github.com/Funnelchat20/whatsapp-api-golang/commit/068b8f8ce4ea8fe9820c8c0415f34e93ea3a78f2))
* **cd:** fetch tags before semantic-release to fix version increment ([ed863c8](https://github.com/Funnelchat20/whatsapp-api-golang/commit/ed863c8b999d1336c3e1853fccc83d860da9c66a))
...
* **webhooks:** handle partial failures in updateWebhookSettings ([c182734](https://github.com/Funnelchat20/whatsapp-api-golang/commit/c182734b254cf1a2cab4e32e0aab13c8d102ccfd))
...
* **dispatch:** improve webhook URL routing with fallback logic ([6409fbe](https://github.com/Funnelchat20/whatsapp-api-golang/commit/6409fbed19ff895e385c76590c415c84f654387d))
* **persistence:** make DLQ insertion idempotent with ON CONFLICT ([991cdf3](https://github.com/Funnelchat20/whatsapp-api-golang/commit/991cdf3ecd1b3c3cd75aa548ad6c9cf631e8b0e1))
...
* **dispatch:** prevent body reader exhaustion on webhook retry ([8e05072](https://github.com/Funnelchat20/whatsapp-api-golang/commit/8e05072e4dd1a3b592244040901f57d84a26a812))
* **ci:** prevent CD failure when no release needed ([f9253c7](https://github.com/Funnelchat20/whatsapp-api-golang/commit/f9253c703fd81ad4fd8e7298fe377ba074efaee4))
...
* **webhooks:** use bulk endpoint for clear all operation ([69225c9](https://github.com/Funnelchat20/whatsapp-api-golang/commit/69225c99636193e6e78e7160c69204dce8a0e1a6))
...
* **docker:** use Debian-based image for testing stage ([1d1944e](https://github.com/Funnelchat20/whatsapp-api-golang/commit/1d1944ef8fa93d922df5c3c2341fc172a1966bee))
* **docker:** use Debian-based image for testing stage ([02d5578](https://github.com/Funnelchat20/whatsapp-api-golang/commit/02d55780ee4180577f349c1f0d1c8e98282c271e))
* **release:** use explicit develop prerelease identifier ([d52a62e](https://github.com/Funnelchat20/whatsapp-api-golang/commit/d52a62e33107bb17a10ac9ba0b50e227394c1786))
* **cd:** use GITHUB_TOKEN for tag fetch authentication ([3afc1fc](https://github.com/Funnelchat20/whatsapp-api-golang/commit/3afc1fc3ddf94d70ad32f06bb543ee2fcfddacdb))
...
* **cd:** separate api and manager docker builds ([e0eee63](https://github.com/Funnelchat20/whatsapp-api-golang/commit/e0eee63d9dbef4d2e2299eb4d4bfe91a58106269))
...
## [2.0.0-develop.1](https://github.com/Funnelchat20/whatsapp-api-golang/compare/v1.2.0-develop.3...v2.0.0-develop.1) (2026-01-15)
