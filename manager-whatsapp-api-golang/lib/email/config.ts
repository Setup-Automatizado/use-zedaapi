 ...
 * Uses APP_URL for frontend links (emails should link to the Manager frontend, not API backend)
 */
const getAppUrl = () => {
	// Priority: APP_URL > NEXT_PUBLIC_APP_URL > BETTER_AUTH_URL > localhost
	return (
		process.env.APP_URL ||
...
export const appConfig = {
	...
	url: getAppUrl(),
	supportEmail: process.env.SUPPORT_EMAIL || "support@whatsapp-manager.com",
	logoUrl: `${getAppUrl()}/android-chrome-192x192.png`,
} as const;
