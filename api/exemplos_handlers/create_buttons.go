...
// ReviewAndPay configuration inputs
...
// NewReviewPayBtnCustom builds a review_and_pay button with fully dynamic order and totals
func (ButtonFactory) NewReviewPayBtnCustom(cfg ReviewAndPayConfig) (*waE2E.InteractiveMessage_NativeFlowMessage_NativeFlowButton, error) {
	// Payment settings (PIX static code)
...
const (
	...
	// Adicione outros tipos de mídia conforme necessário
)
...
func (ButtonMessageFactory) NewMessageButtons(params ButtonMessageParams) (*waE2E.Message, error) {
	...
	// MessageVersion é obrigatório para InteractiveMessage funcionar corretamente
	msgVersion := int32(1)
	...
	// Se houver mídia no header, processa de acordo com o tipo
	if headerMedia != nil {
		...
		// Adicione outros casos de mídia conforme necessário
		default:
	...
	// Se houver review_and_pay entre os botões, definir MessageParamsJSON (alguns clientes exigem)
