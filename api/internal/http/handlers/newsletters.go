...
// NewslettersHandler exposes newsletter-related endpoints mirroring the Zé da API surface.
...
// instance/token prefix to maintain compatibility with the Zé da API contract.
