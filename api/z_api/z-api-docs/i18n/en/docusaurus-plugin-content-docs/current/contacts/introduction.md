...
In this topic you will understand a little more about what the FUNNELCHAT can do when it comes to contacts. We have divided this approach into some topics listed below to better explain.
...
- Everything the FUNNELCHAT can do regarding contacts is the same as what WhatsApp Web can do, that is, almost nothing, it is not possible to add a contact, not even rename it or even delete. Basically, what you need to understand is that WhatsApp Web cannot manipulate your phone's address book, so neither can the **FUNNELCHAT**.
