...
Para ajudar você a entender o funcionamento do FUNNELCHAT, nosso serviço roda com base em um WhatsApp Web, e abstraímos os métodos permitindo que você manipule via API RestFul.
...
É bacana você saber que toda vez que você cria uma instância nossos FlyBots responsáveis por orquestrar todo nosso Devops, inicia o processo de criação de um container com a Stack FUNNELCHAT na Oracle Cloud. Sim! todos nossos serviços são nacionais e rodam na Oracle Cloud.
