...
## FUNNELCHAT - Asas para sua imaginação!

**FUNNELCHAT** foi desenvolvido por **programadores para programadores**, por isso prezamos pela simplicidade e objetividade de tudo que nos propomos a fazer, sendo assim chega de conversa fiada e ** Let's Bora!**

---

## Mas o que é FUNNELCHAT?

Você provavelmente já deve saber, mas vamos reafirmar!

**FUNNELCHAT** é um serviço RestFul que provê uma API que permite que você interaja com seu WhatsApp através de uma API simples e intuitiva, além de webhooks para te avisar sobre interações com seu número.

:::important Importante

O FUNNELCHAT reafirma que não é destinada para prática de SPAM e envio de mensagens indesejadas ou qualquer ação que viole os termos de serviço do WhatsApp.
...
- Utilizadores de soluções de terceiros que permitam integração com FUNNELCHAT

---

## Tá bom! Mas o que dá para fazer com ele?

De forma bem direta, tudo que você faz com WhatsApp Web você poderá fazer utilizando nosso serviço. Para isso basta ler o QRcode do FUNNELCHAT e utilizar nosso serviço!
...
1. Você envia via API uma mensagem para o FUNNELCHAT;

2. O FUNNELCHAT adiciona em uma fila e te retorna o ID da mensagem;
