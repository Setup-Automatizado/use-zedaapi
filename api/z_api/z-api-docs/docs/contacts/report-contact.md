...
`POST` https://api.funnelchat/instances/SUA_INSTANCIA/token/SEU_TOKEN/contacts/{{phone}}/report
...
`POST` https://api.funnelchat/instances/SUA_INSTANCIA/token/SEU_TOKEN/contacts/5544999999999/report
