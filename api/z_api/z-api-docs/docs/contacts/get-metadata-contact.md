...
`GET` https://api.funnelchat/instances/SUA_INSTANCIA/token/SEU_TOKEN/contacts/{phone}
...
`GET` https://api.funnelchat/instances/SUA_INSTANCIA/token/SEU_TOKEN/contacts/5511999999999
