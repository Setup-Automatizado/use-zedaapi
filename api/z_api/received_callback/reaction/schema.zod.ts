...
/**
 * Schema Zod para evento z_api/received_callback/reaction
 * Gerado automaticamente pelo Webhook Mapper
 */
export const ZApiReceivedCallbackReactionSchema = z.object({
  headers: z.object({
    connection: z.string(),
  ...
  body: z.object({
    ...
    broadcast: z.boolean(),
    participantPhone: z.union([z.string()]).optional(),
    ...
    reaction: z.object({
      ...
      referencedMessage: z.object({
        ...
        fromMe: z.boolean(),
        phone: z.string(),
        participant: z.union([z.string()]),
      }),
    }),
  }),
});

export type ZApiReceivedCallbackReaction = z.infer<typeof ZApiReceivedCallbackReactionSchema>;
